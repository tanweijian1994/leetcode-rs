...
fn add_two_numbers_test() {
    assert_eq!(
        Solution::add_two_numbers(
            ListNode::vec_to_linked_list(vec![2, 4, 3]),
            ListNode::vec_to_linked_list(vec![5, 6, 4])
        ),
        ListNode::vec_to_linked_list(vec![7, 0, 8])
    );
    assert_eq!(
        Solution::add_two_numbers(
            ListNode::vec_to_linked_list(vec![1, 2, 3]),
            ListNode::vec_to_linked_list(vec![8, 9, 1])
        ),
        ListNode::vec_to_linked_list(vec![9, 1, 5])
    );
    assert_eq!(
        Solution::add_two_numbers(
            ListNode::vec_to_linked_list(vec![6, 4, 8]),
            ListNode::vec_to_linked_list(vec![5, 6, 9])
        ),
